...
DOWNLOAD_SPEED = [1 * MB]  # per second
UPLOAD_SPEED = [100 * KB, 1 * MB, 10 * MB]  # node's speed, per second
DOWNLOAD_SPEED_LABEL = ["1 * MB", ]  # per second
UPLOAD_SPEED_LABEL = ["100 * KB", "1 * MB", "10 * MB"]  # node's speed LABEL, per second
